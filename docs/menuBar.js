...
var menubar_data_homeURL = 'https://hseadc.github.io/vrub/';
var menu = [{
  text: 'Исполнители',
  url: 'artists.html'
}, {
...
var token = 'pataUogeU3aX0RDHb.3e0dc253f93bbc3048442e94628ce02184cad3ebc4515173467996009f8a4ef6';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('appMPv5NUaVn8bZyR');
  ...
  O_SearchBar_createClass(O_SearchBar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react.createElement("div", {
        ...
        handleSearchSubmit: handleSearchSubmit,
        handleSearchInput: handleSearchInput
      }), searchInputValue.length >= 3 && isSearchButtonDisabled == false && this.renderPostSuggestions());
    }
  }]);
...
function A_MainMenu_typeof(obj) { "@babel/helpers - typeof"; return A_MainMenu_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, A_MainMenu_typeof(obj); }

function A_MainMenu_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function A_MainMenu_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function A_MainMenu_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function A_MainMenu_createClass(Constructor, protoProps, staticProps) { if (protoProps) A_MainMenu_defineProperties(Constructor.prototype, protoProps); if (staticProps) A_MainMenu_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }

function A_MainMenu_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) A_MainMenu_setPrototypeOf(subClass, superClass); }

function A_MainMenu_setPrototypeOf(o, p) { A_MainMenu_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return A_MainMenu_setPrototypeOf(o, p); }

function A_MainMenu_createSuper(Derived) { var hasNativeReflectConstruct = A_MainMenu_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = A_MainMenu_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = A_MainMenu_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return A_MainMenu_possibleConstructorReturn(this, result); }; }

function A_MainMenu_possibleConstructorReturn(self, call) { if (call && (A_MainMenu_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return A_MainMenu_assertThisInitialized(self); }

function A_MainMenu_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function A_MainMenu_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function A_MainMenu_getPrototypeOf(o) { A_MainMenu_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return A_MainMenu_getPrototypeOf(o); }
...
var A_MainMenu = /*#__PURE__*/function (_React$Component) {
  A_MainMenu_inherits(A_MainMenu, _React$Component);

  var _super = A_MainMenu_createSuper(A_MainMenu);

  function A_MainMenu() {
    A_MainMenu_classCallCheck(this, A_MainMenu);

    return _super.apply(this, arguments);
  }

  A_MainMenu_createClass(A_MainMenu, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          text = _this$props.text,
          ...
          url = _this$props.url,
          type = _this$props.type;
      var classes = classnames_default()(A_MainMenu_defineProperty({
        A_MainMenu: true,
        current: current
      }, '${type}', true));
      return /*#__PURE__*/react.createElement("div", {
...
function S_MenuBar_typeof(obj) { "@babel/helpers - typeof"; return S_MenuBar_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, S_MenuBar_typeof(obj); }
...
function S_MenuBar_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function S_MenuBar_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var S_MenuBar = /*#__PURE__*/function (_React$Component) {
  ...
  function S_MenuBar(props) {
    ...
    S_MenuBar_defineProperty(S_MenuBar_assertThisInitialized(_this), "handleSearchSubmit", function () {
      ...
      var prerender = _this.props.prerender;
